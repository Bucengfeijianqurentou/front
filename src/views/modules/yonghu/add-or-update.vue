    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" label="区块链账户" prop="chainCount">
                       <div style="display: flex; flex-direction: column;">
                           <div style="display: flex; align-items: center; margin-bottom: 5px;">
                               <el-input v-model="ruleForm.chainCount" placeholder="区块链账户" readonly style="width: 100%;"></el-input>
                               <el-button size="mini" type="primary" @click="copyToClipboard(ruleForm.chainCount)" style="margin-left: 10px;">复制</el-button>
                           </div>
                           <div v-if="ruleForm.chainCount" style="font-size: 12px; color: #666; margin-top: 5px;">
                               <i class="el-icon-info"></i> 区块链账户是用户在区块链上的唯一标识，用于记录和验证用户相关交易
                           </div>
                           <div v-if="!ruleForm.chainCount" style="font-size: 12px; color: #f56c6c; margin-top: 5px;">
                               <i class="el-icon-warning"></i> 未找到区块链账户信息
                           </div>
                       </div>
                   </el-form-item>
               </el-col>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="部门" prop="bumenTypes">
                        <el-select v-model="ruleForm.bumenTypes" placeholder="请选择部门">
                            <el-option
                                v-for="item in bumenTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='bumenTypes'){
                          this.ruleForm.bumenTypes = obj[o];
                          this.ro.bumenTypes = true;
                          continue;
                      }
                    }
                }
