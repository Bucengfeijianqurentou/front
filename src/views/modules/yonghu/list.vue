        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '区块链账户' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.chainCount" placeholder="区块链账户" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <el-button
                                ...
                                @click="goToRegisterApproval()"
                        >
                            <el-badge v-if="registerApprovalCount > 0" :value="registerApprovalCount" class="item">
                                注册申请
                            </el-badge>
                            <span v-else>注册申请</span>
                        </el-button>
                        &nbsp;
                        <a style="text-decoration:none" class="el-button el-button--success"
                           v-if="isAuth('yonghu','导入导出')"
                           icon="el-icon-download"
                           href="http://localhost:8080/xiaoyuanzichan/upload/yonghuMuBan.xls"
                        >批量导入用户数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yonghu','导入导出')"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            <el-popover
                                ...
                                width="300"
                                trigger="hover">
                                <div style="word-break: break-all;">{{ scope.row.chainCount }}</div>
                                <div style="margin-top: 10px;">
                                    <el-button size="mini" type="text" @click="copyToClipboard(scope.row.chainCount)">复制</el-button>
                                </div>
                                <div slot="reference" class="hash-cell">
                                    {{ scope.row.chainCount ? scope.row.chainCount.substring(0, 16) + '...' : '' }}
                                </div>
                            </el-popover>
                        </template>
                    </el-table-column>
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.chainCount!= '' && this.searchForm.chainCount!= undefined) {
                    params['chainCount'] = '%' + this.searchForm.chainCount + '%'
                }
            ...
            fetchRegisterApprovalCount() {
                ...
                if (this.$storage.get('role') === '管理员') {
                    http({
                        ...
                        if (data && data.code === 0) {
                            console.log('Register approval count in list:', data.data.total);
