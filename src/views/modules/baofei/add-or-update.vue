    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="shangpinId" name="shangpinId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报废数量" prop="baofeiNumber">
                       <el-input v-model="ruleForm.baofeiNumber"
                                 placeholder="报废数量" clearable  :readonly="ro.baofeiNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="报废数量" prop="baofeiNumber">
                           <el-input v-model="ruleForm.baofeiNumber"
                                     placeholder="报废数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="报废备注" prop="baofeiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.baofeiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.baofeiContent" label="报废备注" prop="baofeiContent">
                            <span v-html="ruleForm.baofeiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   baofeiContent: [
                              { required: true, message: '报废备注不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='baofeiNumber'){
                          this.ruleForm.baofeiNumber = obj[o];
                          this.ro.baofeiNumber = true;
                          continue;
                      }
                      if(o=='baofeiContent'){
                          this.ruleForm.baofeiContent = obj[o];
                          this.ro.baofeiContent = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`baofei/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.baofeiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
