        ...
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpinChuruInout'">
                    <el-form-item class="select" v-if="type!='info'"  label="入库" prop="shangpinChuruInoutId">
                        <el-select v-model="ruleForm.shangpinChuruInoutId" filterable placeholder="请选择入库" @change="shangpinChuruInoutChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpinChuruInout' ">
                    <el-form-item class="input" v-if="type!='info'"  label="入库名称" prop="shangpinChuruInoutName">
                        <el-input v-model="shangpinChuruInoutForm.shangpinChuruInoutName"
                                  placeholder="入库名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="入库名称" prop="shangpinChuruInoutName">
                            <el-input v-model="ruleForm.shangpinChuruInoutName"
                                      placeholder="入库名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='shangpinChuruInout' ">
                    <el-form-item class="input" v-if="type!='info'"  label="入库类型" prop="shangpinChuruInoutValue">
                        <el-input v-model="shangpinChuruInoutForm.shangpinChuruInoutValue"
                                  placeholder="入库类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="入库类型" prop="shangpinChuruInoutValue">
            ...
            <input id="shangpinId" name="shangpinId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="入库数量" prop="shangpinChuruInoutListNumber">
                       <el-input v-model="ruleForm.shangpinChuruInoutListNumber"
                                 placeholder="入库数量" clearable  :readonly="ro.shangpinChuruInoutListNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="入库数量" prop="shangpinChuruInoutListNumber">
                           <el-input v-model="ruleForm.shangpinChuruInoutListNumber"
                                     placeholder="入库数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shangpinChuruInoutId'){
                          this.ruleForm.shangpinChuruInoutId = obj[o];
                          this.ro.shangpinChuruInoutId = true;
                          continue;
                      }
                      if(o=='shangpinId'){
                      ...
                      if(o=='shangpinChuruInoutListNumber'){
                          this.ruleForm.shangpinChuruInoutListNumber = obj[o];
                          this.ro.shangpinChuruInoutListNumber = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            info(id) {
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        this.shangpinChuruInoutChange(data.data.shangpinChuruInoutId)
                        //解决前台上传图片后台不显示的问题
