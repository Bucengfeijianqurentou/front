        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '入库名称' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.shangpinChuruInoutName" placeholder="入库名称" clearable></el-input>
                    </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoyuanzichan/upload/shangpinChuruInoutListMuBan.xls"
                        >批量导入入库详情数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpinChuruInoutList','导入导出')"
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '入库名称': 'shangpinChuruInoutName',
                     '入库类型': 'shangpinChuruInoutTypes',
                //本表字段
                     '入库数量': "shangpinChuruInoutListNumber",
                     '操作时间': "insertTime",
            },
